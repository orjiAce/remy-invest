...
<html  data-wf-page="63f4b14a1c14d83f62065d38" data-wf-site="63dccc1ba88f450bf57ed4e1"
      data-wf-status="1">
<?php
...
<div class="section first-section bg-lavender-20 wf-section">
    <div class="container w-container">
        <div class="heading template-page-heading">
            <div class="heading-title max-width-485px"><h2 class="color-dark-100">Privacy policy</h2></div>
            <div class="max-width-720px">
                <div class="text-xl">How Do We Share Your Information?
                </div>
            </div>
        </div>
    </div>
</div>
<div class="section template-page wf-section">
  
    <div class="template-page-content">
        <div class="container w-container">
            <div class="template-contents-list">
                ...
                <p>The Remy Finance website located at remyfinance.com is a copyrighted work belonging to remy finance. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
                ...
                <p><strong>Cookies and Web Beacons.</strong> Like any other website, Remy Finance uses ‘cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
                ...
                <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Office 182, Level 1, Gate Avenue, DIFC, Dubai. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
                ...
                <p>In any circumstances where the foregoing Arbitration Agreement permits the parties to litigate in court, the parties hereby agree to submit to the personal jurisdiction of the courts located within de County, California, for such purposes.</p>
                ...
                <p>Address: Office 182, Level 1, Gate Avenue, DIFC, Dubai</p>
                <p>Email: hello@remyfinance.com</p>
